...
class YourBusinessClass {
	/*
	 * Dependency Injection using Constructor based. Note when using Constructor
	 * based dependency inject @Autowired is not mandatory.
	 */
	...
	public YourBusinessClass(Dependency1 dependency1, Dependency2 dependency2) {
		super();
		System.out.println("Inside constructor of YourBusinessClass");
